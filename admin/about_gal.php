...
if(isset($_POST['submit']))
{
        ...
        $s="INSERT into about_gallery(image)values('$img_new_name')";
        if($conn->query($s)===TRUE){
            echo "<script>alert('Image Added Successfully..!');window.location.href = 'about_gal.php'; </script>";
        }else{
            echo $conn->error;
        }
}
...
{
    $a=$_GET['del'];
    $aa="select * from about_gallery where id='$a'";
    $aaa=$conn->query($aa);
    $rr=$aaa->fetch_assoc();
    $s= "DELETE from about_gallery where id='$a'" ;
    if($conn->query($s)===TRUE)
    {

     echo "<script>alert('Image Deleted Successfully..!');window.location.href='about_gal.php';</script>"; 
    }
    else
    {
    echo $conn->error;
                ...
                <div class="main-content-inner">
                    ...
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Upload Images On Home Gallery</li>
                        </ul><!-- /.breadcrumb -->
        ...
        <div class="col-md-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">View About Gallery</h3>
                </div>
                ...
                <div class="panel-body">                
                    <table id="dynamic-table" class="table table-striped table-bordered table-hover table-responsive" style="font-size:1.2em">
                        ...
                        <?php
                            $count=0;
                            $get = "SELECT * FROM about_gallery ORDER BY id DESC";
                            $sql = $conn->query($get);
                        ...
                        ?>
                            <tr>
                                ...
                                <td><img src="../images/<?php echo $sqli['image'];?>" style="height:150px;width:200px;">
                                </td> 

                                <td>

                                    <a class="red" href="about_gal.php?del=<?php echo $sqli['id'];?>" onclick="return confirm('Are You Sure..?')"><i class="fa fa-trash" style="font-size:1.5em"></i></a>

                                <!--     <a class="blue" href="update_about_gal.php?edt=<?php //echo $sqli['id'];?>"><i class="fa fa-edit" style="font-size:1.5em"></i></a> -->
