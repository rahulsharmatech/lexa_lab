...
if(isset($_GET['edt'])){
    $aa=$_GET['edt'];
    $ss="select * from home_slider where id='$aa'" ;
    $sss=$conn->query($ss);
    $res=$sss->fetch_assoc();
    }
...
if(isset($_POST['sub'])){
    ...
    $s="update home_slider set title='$title',content='$content',image='$img_new_name' where id='$i'";
    if($conn->query($s)===TRUE){
        echo "<script>alert('Home Slider Updated Successfully..!');window.location.href='home_slider.php';</script>";
    }
    else
    {
                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Update Home Slider</li>
                        </ul><!-- /.breadcrumb -->
        ...
        <div class="panel-primary">
            ...
            <div class="panel-body">
                <form role="form" method="post" enctype="multipart/form-data" class="form-horizontal form-groups-bordered">
                    ...
                    <input type="hidden" name="image" value="<?php echo $res['images']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5 col-xs-5">
                            <textarea type="text" name="title" class="form-control datepicker" placeholder="Title" required="" rows="3" cols="4"><?php echo $res['title']; ?></textarea>
                        </div>

                        <label for="title" class="col-md-1 col-xs-1 label-control"> Content : </label>
                        <div class="col-md-5 col-xs-5">
                            <textarea type="text" name="content" class="form-control datepicker" placeholder="Content" required="" rows="3" cols="4"><?php echo $res['content']; ?></textarea>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <img height="150px" width="150px" src="../images/<?php echo $res['image'];?>" id="output" />
                        </div>
