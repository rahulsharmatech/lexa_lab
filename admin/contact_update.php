...
if(isset($_POST['sub'])){
    ...
    $s="update contact set admin_add='$admin_add',corp_add='$corp_add',email='$email',phone='$phone' where id='$i'";
                ...
                <form role="form" method="post" enctype="multipart/form-data" class="form-horizontal form-groups-bordered">
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-md-5 col-xs-5">
                            <textarea type="text" name="admin_add" class="form-control datepicker" placeholder="Address" rows="4" cols="3"  required=""><?php echo $res['admin_add']; ?></textarea>
                        </div>

                         <label for="title" class="col-md-1 col-xs-1 label-control">Corporate Address : </label>
                        <div class="col-md-5 col-xs-5">
                            <textarea type="text" name="corp_add" class="form-control datepicker" placeholder="Address" rows="4" cols="3"  required=""><?php echo $res['corp_add']; ?></textarea>
                        </div>
