...
{
    $aa=$_GET['edt'];
    $ss="select * from blogs where id='$aa'" ;
    $sss=$conn->query($ss);
    $res=$sss->fetch_assoc();
}
...
if(isset($_POST['sub'])){
    ...
    $s="update blogs set title='$title', content='$content', datee='$date', image='$img_new_name' where id='$i' ";
    if($conn->query($s)===TRUE)
    {
        echo "<script>alert('Updation Successfull..!');window.location.href='blogs.php';</script>";
    }
    else
    {
                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Update Blog Section</li>
                        </ul><!-- /.breadcrumb -->
                 ...
                 <input type="hidden" name="idd" value="<?php echo $res['id']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5 col-xs-5">
                            <input type="date" name="date" value="<?php echo $res['datee']; ?>" class="form-control datepicker" placeholder="Enter Title" rows="3" cols="6" required="">
                        </div>

                        <label for="title" class="col-md-1 col-xs-1 label-control">Title: </label>
                        <div class="col-md-5 col-xs-5">
                            <input type="text" name="title" value="<?php echo $res['title']; ?>" class="form-control datepicker" placeholder="Enter Title" rows="3" cols="6" required="">
                        </div>
                        ...
                        <div class="col-md-4 col-xs-4">
                            <textarea type="text" name="content" class="form-control datepicker" placeholder="Enter Title" rows="4" cols="6" required=""><?php echo $res['content']; ?></textarea>
                        </div>
                        ...
                        <div class="col-md-4">
                            <img height="200px" width="300px" src="../images/<?php echo $res['image'];?>" id="output" />
                        </div>
