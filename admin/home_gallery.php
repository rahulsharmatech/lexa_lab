...
if(isset($_POST['submit']))
{
        ...
        $s="INSERT into home_gallery(title,image)values('$title','$img_new_name')";
        if($conn->query($s)===TRUE){
            echo "<script>alert('Image Added Successfully..!');window.location.href = 'home_gallery.php'; </script>";
        }else{
            echo $conn->error;
        }
}
...
{
    $a=$_GET['del'];
    $aa="select * from home_gallery where id='$a'";
    $aaa=$conn->query($aa);
    $rr=$aaa->fetch_assoc();
    $s= "DELETE from home_gallery where id='$a'" ;
    if($conn->query($s)===TRUE)
    {

     echo "<script>alert('Image Deleted Successfull!');window.location.href='home_gallery.php';</script>"; 
    }
    else
    {
    echo $conn->error;
                ...
                <div class="main-content-inner">
                    ...
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Upload Images On Home</li>
                        </ul><!-- /.breadcrumb -->
        ...
        <div class="col-md-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">View Home Gallery</h3>
                </div>
                ...
                <div class="panel-body">                
                    ...
                    <!-- Selete Query -->
                        <?php
                            $count=0;
                            $get = "SELECT * FROM home_gallery ORDER BY id DESC";
                            $sql = $conn->query($get);
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a class="red" href="home_gallery.php?del=<?php echo $sqli['id'];?>" onclick="return confirm('Are You Sure')"><i class="fa fa-trash" style="font-size:1.5em"></i></a>
                                    <a class="blue" href="update_home_gallery.php?edt=<?php echo $sqli['id'];?>"><i class="fa fa-edit" style="font-size:1.5em"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                        </tbody>
