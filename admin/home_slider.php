...
if(isset($_POST['submit']))
{
        ...
        $s="INSERT into home_slider(title,content,image)values('$title','$content','$img_new_name')";
        if($conn->query($s)===TRUE)
        {
            echo "<script>alert('Image Added Successfully..!');window.location.href = 'home_slider.php'; </script>";
        }
        else
        {
            echo $conn->error;
...
{
    $a=$_GET['del'];
    $aa="select * from home_slider where id='$a'";
    $aaa=$conn->query($aa);
    $rr=$aaa->fetch_assoc();
    $s= "DELETE from home_slider where id='$a'" ;
    if($conn->query($s)===TRUE)
    {

     echo "<script>alert('Slider Image Deleted Successfull..!'); window.location.href='home_slider.php';</script>"; 
    }
    else
    {
    echo $conn->error;
                ...
                <form role="form" method="post" enctype="multipart/form-data" class="form-horizontal form-groups-bordered">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-5 col-xs-5">
                            <textarea type="text" name="title" class="form-control datepicker" placeholder="Enter Title" rows="3" cols="6" required=""></textarea>
                        </div>

                        <label for="title" class="col-md-1 col-xs-1 label-control">Content: </label>
                        <div class="col-md-5 col-xs-5">
                            <textarea type="text" name="content" class="form-control datepicker" placeholder="Enter Content" rows="3" cols="6" required=""></textarea>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <img height="200px" width="200px" id="output" />
                        </div>
        ...
        <div class="col-md-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">View Slider Images </h3>
                </div>
                ...
                <div class="panel-body">                
                    ...
                    <!-- Selete Query -->
                        <?php
                            $count=0;
                            $get = "SELECT * FROM home_slider ORDER BY id DESC";
                            $sql = $conn->query($get);
                        ...
                        ?>
                            <tr>
                                ...
                                <td><img src="../images/<?php echo $sqli['image'];?>" style="height:200px;width:300px;"></td> 
                                <td>

                                    <a class="red" href="home_slider.php?del=<?php echo $sqli['id'];?>" onclick="return confirm('Are You Sure..?')"><i class="fa fa-trash" style="font-size:1.5em"></i>
                                    </a>
                                    <a class="blue" href="update_home_slider.php?edt=<?php echo $sqli['id'];?>"><i class="fa fa-edit" style="font-size:1.5em"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                        </tbody>
