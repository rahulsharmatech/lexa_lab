...
{
    $aa=$_GET['edt'];
    $ss="select * from home_gallery where id='$aa'" ;
    $sss=$conn->query($ss);
    $res=$sss->fetch_assoc();
}
...
if(isset($_POST['sub'])){
    ...
    $s="update home_gallery set title='$title', image='$img_new_name' where id='$i'";
    if($conn->query($s)===TRUE){
        echo "<script>alert('Updation Successfull..!');window.location.href='home_gallery.php';</script>";
    }
    else
    {
                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">UPDATE Home Gallery</li>
                        </ul><!-- /.breadcrumb -->
            ...
            <div class="panel-body">
                <form role="form" method="post" enctype="multipart/form-data" class="form-horizontal form-groups-bordered">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <img height="150px" width="200px" src="../images/<?php echo $res['image'];?>" id="output" />
                        </div>
