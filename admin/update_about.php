...
if(isset($_GET['edt'])){
    $aa=$_GET['edt'];
    $ss="select * from about_us where id='$aa'" ;
    $sss=$conn->query($ss);
    $res=$sss->fetch_assoc();
    }
...
if(isset($_POST['sub'])){
    ...
    $s="update about_us set content='$title' where id='$i'";
    if($conn->query($s)===TRUE){
        echo "<script>alert('Updatation Successfull!');window.location.href='about_kcr.php';</script>";
    }
    else
    {
            ...
            <div class="panel-body">
                <form role="form" method="post" enctype="multipart/form-data" class="form-horizontal form-groups-bordered">
                    ...
                    <div class="form-group">
                        <label for="title" class="col-md-2 col-xs-12 label-control"> Content : </label>
                        <div class="col-md-10 col-xs-10">
                            <textarea type="text" name="title" class="form-control datepicker" placeholder="NAME" required="" rows="4" cols="5"><?php echo $res['content']; ?></textarea>
                        </div>
