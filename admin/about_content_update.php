...
if(isset($_GET['edt'])){
    $aa=$_GET['edt'];
    $ss="select * from about_cont where id='$aa'" ;
    $sss=$conn->query($ss);
    $res=$sss->fetch_assoc();
    }
...
if(isset($_POST['sub'])){
    ...
    $s="update about_cont set cont='$cont' where id='$i'";

    if($conn->query($s)===TRUE){
        echo "<script>alert('Updation Successfull..!');window.location.href='about_content.php';</script>";
    }
    else
    {
                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Update About Content</li>
                        </ul><!-- /.breadcrumb -->
                ...
                <form role="form" method="post" enctype="multipart/form-data" class="form-horizontal form-groups-bordered">
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-md-10 col-xs-10">
                            <textarea type="text" name="cont" class="form-control datepicker" placeholder="Address" rows="4" cols="3"  required=""><?php echo $res['cont']; ?></textarea>
                        </div>
